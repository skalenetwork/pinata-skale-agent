...
- `PRIVATE_KEY` from OWS Wallet (use `ows` skill to generate)
...
* Signer Wallet — Which OWS wallet should sign the transaction?
...
| PRIVATE_KEY | string | `0x...` | Or use OWS wallet |
...
See the `ows` skill for complete wallet management.
